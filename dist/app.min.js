...
;angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/main.tpl.html',
    "<div layout=column layout-align=\"center center\"><h1>Hello World!</h1><who-is-hiring></who-is-hiring></div>"
  );
  ...
  $templateCache.put('templates/whoishiring/whoishiring.tpl.html',
    "<div layout=column layout-align=\"center center\"><h2>WhoIsHiring's Job Postings:</h2><div class=whois-controls><input ng-model=storyId> <a href class=btn ng-click=loadStory()>Get Story</a><p>Search Queries:</p><p ng-repeat=\"searchQuery in searchQueries track by $index\"><input ng-model=searchQueries[$index]></p><a href class=btn ng-click=\"searchQueries.push('')\">Add query</a> {{searchQueries}}<p></p></div><div class=postings><div class=posting ng-repeat=\"posting in visiblePostings() | filterByArray: searchQueries\"><div ng-bind-html=posting.htmlText></div></div></div></div>"
  );
